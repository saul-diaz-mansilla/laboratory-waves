...
python3 scripts/03_run_simulations.py --config configs/experiment/sine_matched_testing.yaml
...
python3 scripts/05_dispersion_relation.py --config configs/experiment/sine_matched_testing.yaml
...
python3 scripts/07_scaling_comparison.py --config configs/experiment/gaussian_matched_testing.yaml
